...
\begin{tabular}{p{0.75in} p{4.25in}}
  {\cf empty=}\emph{bool} & If 0, will cause deep images to skip printing
                            ...
                            channels. \\
  {\cf roi=}\emph{xb,xe,yb,ye}[\emph{,zb,ze}] & \\ & Specify a region of interest
        to restrict what pixel range will be printed. The ROI uses
        standard begin/end range form (with each `end' one past the last
        pixel).
\end{tabular}
\apiend

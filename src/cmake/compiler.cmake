...
if (CCACHE_FOUND AND USE_CCACHE AND
    NOT (CMAKE_COMPILER_IS_CLANG AND USE_QT AND (NOT DEFINED ENV{CCACHE_CPP2})))
    set (CMAKE_C_COMPILER_LAUNCHER "${CCACHE_FOUND}" CACHE STRING "Compile launcher for C")
    set (CMAKE_CXX_COMPILER_LAUNCHER "${CCACHE_FOUND}" CACHE STRING "Compile launcher for C++")
endif ()
